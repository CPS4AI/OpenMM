...
int main(int argc, char **argv) {
  ...
  FusedBatchNorm4411(1, 56, 56, 64, tmp259, tmp2, tmp3, 0, 0, tmp261);
  ...
  Relu4(1, 56, 56, 64, tmp261, tmp265, kScale, false);
  ...
  FusedBatchNorm4411(1, 56, 56, 256, tmp290, tmp18, tmp19, 0, 0, tmp293);
  ...
  Relu4(1, 56, 56, 256, tmp293, tmp296, kScale, false);
  ...
  FusedBatchNorm4411(1, 56, 56, 256, tmp319, tmp33, tmp34, 0, 0, tmp322);
  ClearMemSecret1(256, tmp34);
  ClearMemSecret1(256, tmp33);

  uint64_t *tmp325 = make_array<uint64_t>(1, 56, 56, 256);
  Relu4(1, 56, 56, 256, tmp322, tmp325, kScale, false);
  ...
  FusedBatchNorm4411(1, 56, 56, 256, tmp348, tmp48, tmp49, 0, 0, tmp351);
  ...
  Relu4(1, 56, 56, 256, tmp351, tmp355, kScale, false);
  ...
  FusedBatchNorm4411(1, 28, 28, 512, tmp388, tmp64, tmp65, 0, 0, tmp391);
  ClearMemSecret1(512, tmp64);
  ClearMemSecret1(512, tmp65);

  uint64_t *tmp394 = make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp391, tmp394, kScale, false);
  ...
  FusedBatchNorm4411(1, 28, 28, 128, tmp405, tmp74, tmp75, 0, 0, tmp408);
  ...
  Relu4(1, 28, 28, 128, tmp408, tmp412, kScale, false);
  ...
  FusedBatchNorm4411(1, 28, 28, 512, tmp417, tmp79, tmp80, 0, 0, tmp420);
  ClearMemSecret1(512, tmp80);
  ClearMemSecret1(512, tmp79);

  uint64_t *tmp423 = make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp420, tmp423, kScale, false);
  ...
  FusedBatchNorm4411(1, 28, 28, 512, tmp446, tmp94, tmp95, 0, 0, tmp449);
  ClearMemSecret1(512, tmp95);
  ClearMemSecret1(512, tmp94);

  uint64_t *tmp452 = make_array<uint64_t>(1, 28, 28, 512);
  Relu4(1, 28, 28, 512, tmp449, tmp452, kScale, false);
  ...
  FusedBatchNorm4411(1, 28, 28, 512, tmp475, tmp109, tmp110, 0, 0, tmp478);
  ...
  Relu4(1, 28, 28, 512, tmp478, tmp482, kScale, false);
  ...
  FusedBatchNorm4411(1, 14, 14, 1024, tmp515, tmp125, tmp126, 0, 0, tmp518);
  ClearMemSecret1(1024, tmp126);
  ClearMemSecret1(1024, tmp125);

  uint64_t *tmp521 = make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp518, tmp521, kScale, false);
  ...
  FusedBatchNorm4411(1, 14, 14, 1024, tmp544, tmp140, tmp141, 0, 0, tmp547);
  ClearMemSecret1(1024, tmp141);
  ClearMemSecret1(1024, tmp140);

  uint64_t *tmp550 = make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp547, tmp550, kScale, false);
  ...
  FusedBatchNorm4411(1, 14, 14, 1024, tmp573, tmp155, tmp156, 0, 0, tmp576);
  ClearMemSecret1(1024, tmp156);
  ClearMemSecret1(1024, tmp155);

  uint64_t *tmp579 = make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp576, tmp579, kScale, false);
  ...
  FusedBatchNorm4411(1, 14, 14, 1024, tmp602, tmp170, tmp171, 0, 0, tmp605);
  ClearMemSecret1(1024, tmp171);
  ClearMemSecret1(1024, tmp170);

  uint64_t *tmp608 = make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp605, tmp608, kScale, false);
  ...
  FusedBatchNorm4411(1, 14, 14, 1024, tmp631, tmp185, tmp186, 0, 0, tmp634);
  ClearMemSecret1(1024, tmp186);
  ClearMemSecret1(1024, tmp185);

  uint64_t *tmp637 = make_array<uint64_t>(1, 14, 14, 1024);
  Relu4(1, 14, 14, 1024, tmp634, tmp637, kScale, false);
  ...
  FusedBatchNorm4411(1, 14, 14, 1024, tmp660, tmp200, tmp201, 0, 0, tmp663);
  ...
  Relu4(1, 14, 14, 1024, tmp663, tmp667, kScale, false);
  ...
  FusedBatchNorm4411(1, 7, 7, 2048, tmp700, tmp216, tmp217, 0, 0, tmp703);
  ClearMemSecret1(2048, tmp217);
  ClearMemSecret1(2048, tmp216);

  uint64_t *tmp706 = make_array<uint64_t>(1, 7, 7, 2048);
  Relu4(1, 7, 7, 2048, tmp703, tmp706, kScale, false);
  ...
  FusedBatchNorm4411(1, 7, 7, 2048, tmp729, tmp231, tmp232, 0, 0, tmp732);
  ClearMemSecret1(2048, tmp231);
  ClearMemSecret1(2048, tmp232);

  uint64_t *tmp735 = make_array<uint64_t>(1, 7, 7, 2048);
  Relu4(1, 7, 7, 2048, tmp732, tmp735, kScale, false);
  ...
  FusedBatchNorm4411(1, 7, 7, 2048, tmp758, tmp246, tmp247, 0, 0, tmp761);
  ...
  Relu4(1, 7, 7, 2048, tmp761, tmp765, kScale, false);
